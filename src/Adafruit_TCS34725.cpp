 ...
 */
float powf(const float x, const float y) { return (float)(pow((double)x, (double)y)); }
 ...
 *  @return Color temperature in degrees Kelvin
 */
uint16_t Adafruit_TCS34725::calculateColorTemperature_dn40(uint16_t r, uint16_t g, uint16_t b,
                                                           uint16_t c) {
